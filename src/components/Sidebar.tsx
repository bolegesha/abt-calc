    ...
    return (
        <div className="relative">
                        ...
                        {items.map(({ icon: Icon, label, href }) => (
                            <li key={label}>
                                <button
                                    ...
                                    className="w-full text-left flex items-center p-3 hover:bg-[#F5F5F7] rounded-xl transition-colors duration-300 group"
                                >
                                    <Icon
                                        size={20}
                                    ...
                                    />
                                    {!isCollapsed && (
                                        <span className="ml-3 text-[15px] font-medium text-[#1D1D1F]">
                                            {label}
                                        </span>
                                    )}
                                    {isCollapsed && (
            ...
            <button
                ...
                className="absolute top-4 -right-4 p-2 bg-white rounded-full shadow-md hover:bg-[#F5F5F7] transition-colors duration-300"
